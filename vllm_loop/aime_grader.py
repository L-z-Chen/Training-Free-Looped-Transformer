"""AIME answer grading, vendored verbatim from lm-evaluation-harness
(lm_eval/tasks/aime/utils.py, v0.4.13, MIT License, EleutherAI).

Vendored so the vLLM venv, which does not carry lm-eval, grades exactly as the reported
runs did; do not edit the grading logic below.
"""
import re
